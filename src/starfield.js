...
const LAYERS = [
  { count: 180, speed: 0.008, minR: 0.4, maxR: 0.8, alpha: 0.4 },  // distant
  { count: 100, speed: 0.020, minR: 0.7, maxR: 1.2, alpha: 0.65 }, // mid
  { count:  50, speed: 0.045, minR: 1.0, maxR: 1.8, alpha: 0.9 },  // near
];
